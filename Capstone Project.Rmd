...
stringsurefinal <- function(string, ngramdata, stringdata) {
        ...
        if(strdisp > 0) {
                if(length(ngramwhere) >0) {
                        ...
                        print(head(strwhere))
                        print(head(stringdata[strwhere]))
...
1. VER SI VALE LA PENA REEMPLAZAR SÍMBOLO "â" POR "'"
2. AGREGAR 5GRAMS A WORDPREDGRAMS / AJUSTAR LOS OTROS (SI APLICA POR 1)
3. PASAR A DATA PRODUCT + PPT!