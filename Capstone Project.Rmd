...
Function that nested the previous function, within a loop along the length of the dataset.  The returned data frame was grouped by words, summarized and arranged by frequency in order to easily visualize the most frequent n_grams within each dataset.
