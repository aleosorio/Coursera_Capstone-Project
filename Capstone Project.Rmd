...
So, besides string N°4 ("a", whose next-word predictions vary between 4 possible values: "good", "great", "few" and "little") the rest had pretty stable predictions.
...
Applying vectwordpred function to the obtained input, with 10 predicted next words, within a dataset 1% of testdata:
```{r, cache = TRUE}
wordpred1grams <- vectwordpred(popular1grams$string, 10, testdata, 0.001)
```
