...
Meaning that all 1-grams with equal or higher frequency than 6, that belong in the freq_twitter$string vector, should be considered within said 60% threshold.
