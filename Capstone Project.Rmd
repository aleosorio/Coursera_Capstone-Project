...
2. Output obtained, with 9 predicted next words, within a dataset 1% of testdata:
```{r, cache = TRUE}
mtxwordpred(freq_twitter$string[1:10], 9, testdata, 0.001)
```
