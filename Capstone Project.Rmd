...
The following function turns strings into lower-case format and splits them into pargraphs (using ".", ":", "?", "!" type characters and ommiting some trivial abbreviations, such as "sr.", "mr.", "mrs.", "apt.", "ave.", "blvd.", "bldg.", "ct.", "dr.", "ext.", "ft.", "fwy.", "hwy.", ln.", "mt.", "sq.", "rd.", "st.", "in.", "mi.", "yd.", "lb.", "oz.", "qt.", "pt.", "gal.", "cal.", "mph." ).  Each paragraph is treated as an extra vector element.
```{r}
...
Afterwards, all 1-gram, 2-gram and "" strings were eliminated with the following function:
```{r}
subsetstring <- function(dataset) {
        result <- subset(dataset, str_count(dataset, pattern = boundary("word")) > 2)
        return(result)
}
```
